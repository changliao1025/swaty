...
def swat_plot_stream_discharge(sFilename_configuration_in, sCase_in = None, sJob_in = None, sModel_in = None):
    ...
    ax.set_xlabel('Time')
    ax.set_ylabel('Stream discharge (units: cms)')
    ...
    #plt.show()
    sFilename_out = sWorkspace_simulation + slash + 'discharge_daily.png'
...
if __name__ == '__main__':
    ...
    swat_plot_stream_discharge(sFilename_configuration, sCase, sJob, sModel)
