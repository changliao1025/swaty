...
def swat_prepare_temperature_file(sFilename_configuration_in):
    ...
    #write out 
    sFilename_temperature = sWorkspace_data + slash + 'data.tmp'    
...
if __name__ == '__main__':
    ...
    swat_prepare_temperature_file(sFilename_configuration)
