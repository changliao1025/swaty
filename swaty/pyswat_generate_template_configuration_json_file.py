...
def swaty_generate_template_configuration_json_file(sFilename_json):
    ...
    aConfig['sWorkspace_data'] = '/global/homes/l/liao313/data'
    ...
    aConfig['sWorkspace_simulation_copy'] = '/global/homes/l/liao313/04model/swat/arw'
    aConfig['sFilename_hru_combination'] = 'obs.flow_am.csv'
